        ...
        <div class="card flex-fill">
            <div class="card-header d-flex justify-content-between">
                <div class="d-flex align-items-center">
                    <h5 class="card-title mb-0">Farmers Report &bull; {{ $totalRecords }} Farmer in Total</h5>
                </div>
                <div style="width: 30%">
                    <form action="{{ url('president/reports/farmers') }}" method="get" class="d-flex justify-cotent-end">
