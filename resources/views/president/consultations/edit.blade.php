                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3" style="margin-top: 15px">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="latitude" id="latitude" class="form-control" value="{{ $consultation->latitude ?? '' }}" readonly />
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Longitude</label>
                            <input type="text" name="longitude" id="longitude" class="form-control" value="{{ $consultation->longitude ?? '' }}" readonly />
                        </div>
                    </div>
                </div>
            </div>
