...
class ListingDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'admin.listings.action')
            ->setRowId('id');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make(['data' => 'owner', 'title' => 'Owner']),
            Column::make(['data' => 'acres', 'title' => 'Acres']),
            Column::make(['data' => 'acre_value', 'title' => 'Acre Value']),
            Column::make(['data' => 'address', 'title' => 'Mailing Address']),
            Column::make(['data' => 'location', 'title' => 'Location']),
            Column::make(['data' => 'parcen_id', 'title' => 'Parcel ID']),
